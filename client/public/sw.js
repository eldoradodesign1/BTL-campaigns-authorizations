const CACHE_NAME = "btl-campaign-authorizations-v2";
const APP_SHELL = ["./", "./index.html", "./manifest.webmanifest", "./authorization-favicon.svg?v=2", "./btl-beyond-the-line-v2.webp"];
